...
const NYXIA_UI_CSS = `
.gjs-editor, .gjs-one-bg, .gjs-two-bg, .gjs-three-bg, .gjs-four-bg {
  font-family: 'Outfit', ui-sans-serif, system-ui, sans-serif !important;
  font-size: 11px !important;
}
.gjs-toolbar { display: none !important; }
.gjs-pn, .gjs-pn-left, .gjs-pn-panel { width: 180px !important; min-width: 180px !important; max-width: 180px !important; padding: 0 !important; }
.gjs-pn-btn { width: 20px !important; height: 20px !important; font-size: 9px !important; margin: 0 !important; padding: 0 !important; line-height: 20px !important; }
...
.gjs-layer-vis { width: 12px !important; height: 12px !important; }
...
.gjs-field input, .gjs-field select, .gjs-field textarea { font-size: 9px !important; padding: 1px 3px !important; height: 18px !important; }
.gjs-devices-c .gjs-devices-btn { padding: 1px 4px !important; font-size: 9px !important; }
...
.gjs-toast { font-size: 9px !important; }
.gjs-badge { font-size: 7px !important; }
.gjs-selected { outline-width: 1px !important; }
.gjs-pn-panel::-webkit-scrollbar, .gjs-sm-scroll::-webkit-scrollbar, .gjs-layers::-webkit-scrollbar, .gjs-blocks::-webkit-scrollbar, .gjs-cv-canvas::-webkit-scrollbar { width: 3px !important; }
.gjs-pn-panel::-webkit-scrollbar-thumb, .gjs-sm-scroll::-webkit-scrollbar-thumb, .gjs-layers::-webkit-scrollbar-thumb, .gjs-blocks::-webkit-scrollbar-thumb, .gjs-cv-canvas::-webkit-scrollbar-thumb { background: #7B5CFF33 !important; border-radius: 2px !important; }
.gjs-pn-panel::-webkit-scrollbar-track, .gjs-sm-scroll::-webkit-scrollbar-track, .gjs-layers::-webkit-scrollbar-track, .gjs-blocks::-webkit-scrollbar-track, .gjs-cv-canvas::-webkit-scrollbar-track { background: transparent !important; }
...
export default function GrapesJSLessonEditor({
  initialHtml, initialCss, onSave, onClose,
  ...
  useEffect(() => {
    ...
    async function initEditor() {
      try {
        ...
        const editor = grapesjs.init({
          ...
          canvas: { styles: (initialCss || undefined) as unknown as undefined },
        ...
        if (isMounted) { setIsLoading(false); toast.error("Erreur lors du chargement de l'éditeur") }
      }
    }
    ...
    return () => {
      ...
      if (editorInstance.current) { try { editorInstance.current.destroy() } catch { /* ignore */ } editorInstance.current = null }
    }
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      if (onSave) onSave({ html_content: html, css_content: css })
