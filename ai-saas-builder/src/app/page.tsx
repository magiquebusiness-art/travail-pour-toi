      ...
      <section id="pricing" className="relative z-10 px-6 py-24 md:px-12 lg:px-24">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start relative">
            ...
            {/* ─── STARTER ─── */}
            <Card className="glass-card rounded-3xl p-8 glass-card-hover border-violet-500/20">
              {/* Badge TON DÉPART */}
              <div className="mb-6">
                <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-violet-500/20 border border-violet-500/40 text-violet-300 text-xs font-bold tracking-wider uppercase">
                  TON DÉPART
                </span>
              </div>
              <CardContent className="p-0">
                <div className="text-center mb-8">
                  <p className="text-violet-400 font-bold tracking-widest uppercase text-lg mb-6">Starter</p>
                  <div className="flex items-baseline justify-center gap-1 mb-2">
                    <span className="text-6xl font-black text-white">19</span>
                  </div>
                  <p className="text-violet-400/60 text-xs font-bold tracking-wider uppercase mb-1">CAS</p>
                  <p className="text-zinc-500 text-sm">par mois</p>
                </div>
                <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                  L'IA NyXia crée votre site d'affiliation en 60 secondes.<br />
                  Puis elle publie automatiquement du contenu 24h/24 et 7j/7...<br />
                  <span className="text-zinc-300 font-medium">Gagnez du temps et de l'argent grâce à notre IA qui travaille pour toi en permanence.</span>
                </p>
                ...
                <a href="https://www.publication-web.com/affiliation/paiement" target="_blank" className="block">
                  <Button size="lg" className="w-full rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 text-white border-0 py-5 font-semibold shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 hover:scale-[1.02] transition-all group">
                    Commencer
            ...
            <Card className="glass-card rounded-3xl p-8 md:scale-105 md:-my-4 relative border-violet-500/50 glow-pulse-intense shimmer z-10">
              ...
              <div className="mb-6">
                <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-violet-500/30 border border-violet-500/50 text-violet-200 text-xs font-bold tracking-wider uppercase">
                  ⭐ LE PLUS POPULAIRE
                </span>
              </div>
              <CardContent className="p-0">
            ...
            {/* ─── META-PRESENCE ─── */}
            <Card className="glass-card rounded-3xl p-8 glass-card-hover border-emerald-500/30">
              {/* Badge LE PRODUIT PHARE */}
              <div className="mb-6">
                <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-emerald-500/20 border border-emerald-500/40 text-emerald-300 text-xs font-bold tracking-wider uppercase">
                  🌟 LE PRODUIT PHARE
                </span>
              </div>
              <CardContent className="p-0">
                <div className="text-center mb-8">
                  <p className="text-emerald-400 font-bold tracking-widest uppercase text-lg mb-6">Meta-Presence</p>
                  <div className="flex items-baseline justify-center gap-1 mb-2">
                    <span className="text-6xl font-black text-white">97</span>
                  </div>
                  <p className="text-emerald-400/60 text-xs font-bold tracking-wider uppercase mb-1">CAS</p>
                  <p className="text-zinc-500 text-sm">une fois · Pour les entreprises en croissance</p>
                </div>
                <ul className="space-y-3 mb-8">
                  {[
                    "Page Facebook professionnelle",
                    "ManyChat configuré DM auto",
                    "30 jours publications générées par IA",
                    "90 jours stratégie redirection",
                    "Objectif 10 000 followers",
                  ].map((feature, i) => (
                    <li key={i} className="flex items-center gap-3 text-zinc-300 text-sm">
                      <Check className="w-4 h-4 text-green-500 shrink-0" />
                      {feature}
                ...
                <Link href="https://nyxiapublicationweb.com" target="_blank" className="block">
                  <Button size="lg" className="w-full rounded-xl bg-gradient-to-r from-emerald-600 to-green-600 text-white border-0 py-5 font-semibold shadow-lg shadow-emerald-500/30 hover:shadow-emerald-500/50 hover:scale-[1.02] transition-all group">
                    Le produit phare
                    <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
                  </Button>
                </Link>
