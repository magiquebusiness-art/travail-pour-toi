...
export const AGENT_TOOLS = [
  {
    type:"function", function:{
      name:"agent_call",
      description:"Délègue une tâche à un agent spécialisé de NyXia. Utilise cet outil quand la demande nécessite une expertise spécifique : copywriting, design, développement, SEO, community management, affiliation, analyse ou support.",
      parameters:{ type:"object", properties:{
        agent:       { type:"string", enum:["copywriter","designer","developer","seo","community","affiliation","analyst","support"], description:"Agent spécialisé à utiliser" },
        task:        { type:"string", description:"Description précise de la tâche à confier à l'agent" },
        context:     { type:"object", description:"Contexte supplémentaire (produit, public, langue, ton...)" },
        agent_type:  { type:"string", enum:["copywriter_landing","copywriter_email","copywriter_desc","community_30days","analyst_report","support_ticket"], description:"Type de tâche préconfiguré pour les agents complets (optionnel)" },
      }, required:["agent","task"] }
    }
  },
  {
    type:"function", function:{
      name:"orchestrate",
      description:"Lance l'orchestration complète : NyXia analyse la demande, identifie automatiquement les agents nécessaires, les lance en parallèle et synthétise les résultats. Utilise pour les tâches complexes multi-domaines.",
      parameters:{ type:"object", properties:{
        task:    { type:"string", description:"Tâche principale à accomplir" },
  ...
  },
  {
    type:"function", function:{
      ...
      description:"Analyse une demande et retourne la liste des agents les plus adaptés pour la traiter, avec leur score de pertinence.",
      parameters:{ type:"object", properties:{
        text: { type:"string", description:"Texte de la demande à classifier" },
      }, required:["text"] }
    }
  },
];
